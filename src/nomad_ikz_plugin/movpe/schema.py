...
def fill_values(subsection: ArchiveSection, time_series_quantity: str, time_series_key: str, dictionary: dict):
    ...
    if (
        ...
        and hasattr(
            getattr(getattr(subsection, time_series_quantity), 'value'), 'm'
        )
        and hasattr(getattr(subsection, time_series_quantity), 'time')
        and hasattr(
            getattr(getattr(subsection, time_series_quantity), 'time'), 'm'
        )
        ):
...
class GrowthMovpeIKZ(VaporDeposition, PlotSection, EntryData):
    ...
    def normalize(self, archive, logger):
        ...
        fil_t = {'Filament T': {'value': np.array([]), 'time': np.array([]), 'set_value': np.array([]), 'set_time': np.array([])}}
        shaft_t = {'Shaft T': {'value': np.array([]), 'time': np.array([]), 'set_value': np.array([]), 'set_time': np.array([])}}
        chamber_p = {'Chamber P': {'value': np.array([]), 'time': np.array([]), 'set_value': np.array([]), 'set_time': np.array([])}}
        throttle_valve = {
            'Throttle Valve': {'value': np.array([]), 'time': np.array([]), 'set_value': np.array([]), 'set_time': np.array([])}
        }
        rotation = {'Rotation': {'value': np.array([]), 'time': np.array([]), 'set_value': np.array([]), 'set_time': np.array([])}}
        sources_p = {}
        sources_t = {}
        if self.steps is not None:
            for step in self.steps:
                if step.sample_parameters is not None:
                    for sample_param in step.sample_parameters:
                        fill_values(sample_param, 'filament_temperature', 'Filament T', fil_t)
                        fill_values(sample_param, 'shaft_temperature', 'Shaft T', shaft_t)
                if step.environment is not None:
                    ...
                    fill_values(step.environment, 'throttle_valve', 'Throttle Valve', throttle_valve)
